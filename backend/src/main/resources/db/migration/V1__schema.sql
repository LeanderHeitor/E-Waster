-- =========================================================
-- V1 — Schema inicial do E-Waster
-- Equivale ao arquivo "Banco de Dados" da raiz, sem o CREATE DATABASE.
--
-- NOTA: as colunas de "enum" (tipo do usuario e status do agendamento)
-- sao VARCHAR, nao enum nativo do Postgres. Isso casa com o mapeamento
-- JPA @Enumerated(EnumType.STRING) das entidades e com o banco que ja
-- funciona. Enum nativo do Postgres quebra o INSERT do Hibernate
